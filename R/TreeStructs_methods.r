...
run_all.TreeStructs <- function(obj, calc_dbh = T, ...) {
    ...
    if (check_property(obj, "has_toplogy")) obj = assign_cyls_to_crown(obj)
    if (check_property(obj, "has_toplogy")) obj = make_convhull(obj) # convhull won't work on hand measured branches
